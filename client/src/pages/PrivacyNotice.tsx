      ...
      <main className="pt-16">
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <Section title="How we collect your information">
            ...
            <div className="rounded-2xl border border-logo-purple/20 bg-soft-lilac p-7 sm:p-9">
              ...
              <div className="space-y-5">
                ...
                <p>For one limited Apollo MCP company-first discovery pilot, we may use Apollo to identify organisations that appear to match our business criteria. We check the organisation&apos;s identity and carry out our conflict screen before requesting personal information.</p>
                <p>For no more than five selected organisations, we may obtain one relevant person&apos;s name, current business role, employer, Apollo-issued identifier, verified work email and verification status. We use those person-level results only to count whether Apollo found a suitable role and verified work email, then discard them. We do not create an Apollo contact, write the information to our CRM, contact the person, make a decision about them or use the information for automated sending.</p>
          ...
          <Section title="International data transfers">
            ...
            <p>During the Apollo discovery pilot, limited business-contact information may pass through Cognition&apos;s Devin service and its authorised subprocessors before Traviz counts the anonymous pilot result and discards the person-level values. Traviz has disabled use of its data for model training. Cognition processes this information on our instructions under its data-processing terms. Relevant international transfers are protected by the UK Addendum to the EU Standard Contractual Clauses or another applicable lawful mechanism. Information processed through Devin is retained in accordance with our applicable Cognition agreement and configured data controls.</p>
          </Section>
          ...
          <Section title="How long we keep your information">
            ...
            <NoticeTable
              ...
              rows={[
                ...
                [<strong className="text-charcoal">Apollo discovery-pilot processing</strong>, "Traviz does not create Apollo contacts or write person-level results to its CRM. Person-level values are discarded after anonymous aggregate counting. Information passing through Devin is retained in accordance with our Cognition agreement and configured data controls."],
              ]}
            />
