      ...
      <main className="pt-16">
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <Section title="How we collect your information">
            ...
            <p>For the bounded transient supplier-evaluation processing described below, we make this information publicly available rather than retaining contact information and initiating a communication solely to describe a short internal test. For the limited Apollo discovery pilot, accepted records may be retained as described below, but no outreach is authorised by the pilot.</p>
            <div className="rounded-2xl border border-logo-purple/20 bg-soft-lilac p-7 sm:p-9">
              ...
              <div className="space-y-5">
                ...
                <p>For no more than five selected organisations, we may obtain one relevant person&apos;s name, current business role, employer, Apollo-issued identifier, verified work email and verification status. We may save an accepted record in Apollo and our internal CRM for internal prospect research and review. The pilot does not authorise us to contact that person, make a decision about them or use their information for automated sending.</p>
                <p>Accepted Apollo discovery-pilot records are reviewed within 12 months. We check Apollo&apos;s Removal Requests list at least every 30 days while those records remain saved, honour objections and opt-outs, and retain only the minimum suppression information needed to avoid renewed contact or processing.</p>
          ...
          <Section title="How we use your information">
            ...
            {bullets([
              ...
              "To identify and internally review up to five business contacts during the limited Apollo discovery pilot; no outreach is authorised by that pilot.",
            ])}
          </Section>
          ...
          <Section title="How long we keep your information">
            ...
            <NoticeTable
              ...
              rows={[
                ...
                [<strong className="text-charcoal">Apollo discovery-pilot contacts</strong>, "Unaccepted results are discarded during the attended pilot. Up to five accepted contacts saved in Apollo and our CRM are reviewed within 12 months. Apollo Removal Requests are checked at least every 30 days while those contacts remain saved."],
              ]}
            />
