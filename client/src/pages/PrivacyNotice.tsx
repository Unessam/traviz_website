      ...
      <main className="pt-16">
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <Section title="How we collect your information">
            ...
            <div className="rounded-2xl border border-logo-purple/20 bg-soft-lilac p-7 sm:p-9">
              ...
              <div className="space-y-5">
                ...
                <p>For one limited Apollo company-first discovery pilot, we may use Apollo&apos;s official MCP connection through Devin to identify organisations that appear to match our business criteria. This MCP stage processes company information only. We check the organisation&apos;s identity and carry out our conflict screen before requesting personal information.</p>
                <p>For no more than five selected organisations, an isolated local process may obtain up to ten current professional-role candidates, choose one person using fixed role, company-size, seniority and tenure rules, and check that person&apos;s verified work email. Person-level Apollo results do not pass through Devin. We use those results only to count whether Apollo found a suitable role and verified work email, then discard them. We do not create an Apollo contact, write the information to our CRM, contact the person, make a decision about them or use the information for automated sending.</p>
                <p>If an Apollo search or enrichment tool unexpectedly saves or retains a contact in the Traviz Apollo workspace, the pilot stops and the record is handled under Apollo&apos;s applicable Removal Request and deletion requirements.</p>
          ...
          <Section title="Who we share your information with">
            ...
            <NoticeTable
              ...
              rows={[
                ...
                [<strong className="text-charcoal">Cognition AI, Inc. (Devin)</strong>, "AI-assisted company-only processing during the attended Apollo discovery pilot; Apollo person-search and enrichment results do not pass through Devin", "Cognition acts as our processor under its data-processing terms. We have disabled use of Traviz data for model training. Cognition may use authorised subprocessors, including model-hosting providers, to provide Devin. Where personal information is transferred outside the UK, the applicable contractual transfer safeguards include the UK Addendum to the EU Standard Contractual Clauses or another lawful transfer mechanism."],
              ]}
            />
          ...
          <Section title="International data transfers">
            ...
            <p>During the Apollo discovery pilot, company information may pass through Cognition&apos;s Devin service and its authorised subprocessors. Apollo person-search and enrichment results are handled by an isolated local process and do not pass through Devin. Traviz has disabled use of its data for model training and disabled access to Anthropic and OpenAI models that require data retention. Cognition processes information on our instructions under its data-processing terms. Relevant international transfers are protected by the UK Addendum to the EU Standard Contractual Clauses or another applicable lawful mechanism. Information processed through Devin is retained in accordance with our applicable Cognition agreement and configured data controls.</p>
          </Section>
          ...
          <Section title="How long we keep your information">
            ...
            <NoticeTable
              ...
              rows={[
                ...
                [<strong className="text-charcoal">Apollo discovery-pilot processing</strong>, "Traviz does not create Apollo contacts or write person-level results to its CRM. Person-level values are handled only by an isolated local process and discarded after anonymous aggregate counting. Company information passing through Devin is retained in accordance with our Cognition agreement and configured data controls."],
              ]}
            />
