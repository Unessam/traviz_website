      ...
      <main className="pt-16">
        <section className="bg-charcoal py-20 text-white">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wider text-electric-teal">Version 1.3</p>
            <h1 className="mb-6 text-4xl font-bold leading-tight sm:text-5xl">Privacy Notice</h1>
            <p className="text-lg leading-relaxed text-gray-100">Effective date: 10 September 2026</p>
          </div>
        </section>
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <Section title="What this notice covers">
            ...
            {bullets([
              ...
              "Are included in a limited business-contact supplier-evaluation test.",
            ])}
            <p>Traviz provides services primarily on a B2B basis. This notice applies to individuals whose personal information Traviz processes as controller through its website, contact form, B2B outreach activity, and limited supplier-evaluation testing. It does not replace a client&apos;s privacy information where Traviz acts solely as that client&apos;s processor.</p>
          </Section>
          ...
          <Section title="Personal information we collect">
            ...
            <NoticeTable
              headers={["Category", "Information collected", "Purpose"]}
              rows={[
                [<strong className="text-charcoal">Business-contact details</strong>, "Name, business role/title, business email address, employer/organisation name", "To make and manage relevant B2B outreach and to record contact preferences"],
              ]}
            />
            <p>We hold only a limited set of business-contact information. We do not build detailed profiles or buy bulk contact lists. We may use a business-to-business information provider for the limited supplier-evaluation testing described below.</p>
          ...
          <Section title="How we collect your information">
            ...
            {bullets([
              ...
              <><strong className="text-charcoal">From other sources</strong> for B2B outreach and limited supplier-evaluation testing, as described below.</>,
            ])}
            ...
            <p>For the bounded supplier-evaluation processing described below, we make this information publicly available rather than retaining contact information and initiating a communication solely to describe a transient internal test. This position applies only to that limited test.</p>
          ...
          <Section title="Lawful bases for processing">
            ...
            <NoticeTable
              ...
              rows={[
                ...
                [<strong className="text-charcoal">Business-contact supplier evaluation</strong>, "Legitimate interests (Article 6(1)(f))", "We process limited professional information temporarily to test the accuracy and suitability of business-contact data sources and processes."],
            ...
            <p>Traviz maintains documented legitimate-interests assessments for processing contact form submissions, B2B outreach, and limited business-contact supplier evaluation. You may object to processing based on legitimate interests at any time (see “Your rights”).</p>
          ...
          <Section title="How we use your information">
            ...
            {bullets([
              ...
              "To make and manage relevant B2B outreach, and to record your contact preferences, including any request not to be contacted; and",
              "To run limited supplier-evaluation tests as described in this notice.",
            ])}
          </Section>

          <Section title="Who we share your information with">
            <p>We may share your personal information with the following service providers:</p>
            <NoticeTable
              ...
              rows={[
                ...
                [<strong className="text-charcoal">Apollo.io (ZenLeads, Inc.)</strong>, "Limited business-contact supplier evaluation, including returning Apollo's provider-issued identifier to retrieve the matching business-contact record", "An applicable UK transfer mechanism, including the UK Extension to the EU-US Data Privacy Framework while it lawfully applies, or other appropriate safeguards"],
              ]}
            />
