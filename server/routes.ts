...
import { createContactNotifier } from "./contactNotification";
import {
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  const contactNotifier = createContactNotifier();
  ...
  app.post('/api/contact', async (req, res) => {
    try {
      ...
      // Send notification via Postmark abstraction
      // Notification failure must NOT fail the request or lose the stored submission
      await contactNotifier.notify({
